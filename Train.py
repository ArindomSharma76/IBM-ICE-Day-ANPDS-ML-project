import os
import numpy as np
from sklearn.svm import SVC#The module:sklearn.svm module includes Support Vector Machine algorithms.
...
print('reading data')
training_dataset_dir = 'C:/Users/Arindom/Desktop/CODE/Dataset'
...
svc_model.fit(image_data, target_data)#Fit the SVM model according to the given training data.
...
filename = 'C:/Users/Arindom/Desktop/CODE/model.sav'
pickle.dump(svc_model, open(filename, 'wb'))#Write a pickled representation of obj to the open file object file.
print("model saved")